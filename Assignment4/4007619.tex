...
\\
\noindent \underline{Solution}:\\ The logically equivalent formula for this would be: \\
$(\phi \ \textbf{U} \ \psi$) \equiv \  $(\phi \ \textbf{W} \ \psi) \ \wedge \ $\lozenge(\psi)$ \\
...
\noindent \underline{Solution}:\\
\square $(\lnot(b \wedge l) \rightarrow \lnot \bigcirc(a \vee c)) $
\end{itemize}
...
\noindent \underline{Solution}:\\
\square $((a \wedge \lnot c) \rightarrow \lozenge(b \ \textbf{U} \ a)) $
\end{itemize}
